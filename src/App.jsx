...
// ─── TODO: cuando conectes Apps Script, descomentá estas líneas ───
// import {
//   fetchAlumnos, marcarAsistencia as apiMarcar, cambiarPIN as apiPIN
...
/* ══════════════════════════════════════════════════════════════
   MOCK DATA  (reemplazar con fetchAlumnos() cuando tengas API)
══════════════════════════════════════════════════════════════ */
const INCOME_DATA = [
...
// Campo unificado: asistencia usa siempre { f: "dd/mm", m: "P"|"I"|"X"|"R"|"" }
// Campo unificado: pagos usa siempre { Enero: 650000, Febrero: 650000, ... }
const INITIAL_STUDENTS = [
  { id:1,  pin:"1234", nombre:"Vale Marengo",   iniciales:"VM", estado:"OK",      abonadas:39, realizadas:33, email:"valeriamarengo@hotmail.com",     tel:"981130838",    plan:"12 Clases",
    pagos:{Enero:740000,Febrero:650000,Marzo:650000,Abril:650000},
    asistencia:[{f:"07/04",m:"P"},{f:"09/04",m:"P"},{f:"14/04",m:"P"},{f:"16/04",m:"P"},{f:"22/04",m:"P"},{f:"24/04",m:"P"},{f:"28/04",m:"P"},{f:"30/04",m:"P"}] },
  { id:2,  pin:"0002", nombre:"Euge",            iniciales:"EU", estado:"OK",      abonadas:11, realizadas:8,  email:"", tel:"981419378", plan:"8 Clases",
    pagos:{Enero:262000,Febrero:350000,Marzo:350000},
    asistencia:[{f:"07/04",m:""},{f:"09/04",m:""},{f:"22/04",m:"P"},{f:"28/04",m:"P"}] },
  { id:3,  pin:"0003", nombre:"Arnaldo",         iniciales:"AR", estado:"OK",      abonadas:11, realizadas:8,  email:"", tel:"981419378", plan:"8 Clases",
    pagos:{Enero:263000,Febrero:350000,Marzo:350000},
    asistencia:[{f:"07/04",m:""},{f:"22/04",m:"P"},{f:"28/04",m:"P"}] },
  { id:4,  pin:"4444", nombre:"Diego Sanchez",   iniciales:"DS", estado:"VENCIDO", abonadas:12, realizadas:12, email:"D.sanchezareco@gmail.com", tel:"991703651", plan:"12 Clases",
    pagos:{Febrero:90000,Marzo:220000,Abril:700000},
    asistencia:[{f:"07/04",m:"P"},{f:"09/04",m:"P"},{f:"14/04",m:"P"},{f:"16/04",m:"P"},{f:"22/04",m:"P"},{f:"24/04",m:"P"},{f:"28/04",m:"P"},{f:"30/04",m:"P"}] },
  { id:5,  pin:"0000", nombre:"Lucho Rolando",   iniciales:"LR", estado:"OK",      abonadas:6,  realizadas:2,  email:"luisangelrolando2024@gmail.com", tel:"595971515309", plan:"4 Clases",
    pagos:{},
    asistencia:[{f:"14/04",m:"I"},{f:"24/04",m:"X"}] },
  { id:7,  pin:"7777", nombre:"Miguel Zacarias", iniciales:"MZ", estado:"OK",      abonadas:32, realizadas:25, email:"mzacarias@grupomipac.com", tel:"981693213", plan:"8 Clases",
    pagos:{Febrero:550000,Marzo:840000,Abril:840000},
    asistencia:[{f:"28/04",m:"P"},{f:"30/04",m:"P"}] },
  { id:8,  pin:"0008", nombre:"Lucy",            iniciales:"LU", estado:"OK",      abonadas:24, realizadas:20, email:"lucymedinavazquez@gmail.com", tel:"981509440", plan:"8 Clases",
    pagos:{Febrero:650000,Marzo:700000,Abril:700000},
    asistencia:[{f:"22/04",m:"P"},{f:"24/04",m:"P"},{f:"28/04",m:"P"},{f:"30/04",m:"I"}] },
  { id:10, pin:"1010", nombre:"Rosse Rivelli",   iniciales:"RR", estado:"OK",      abonadas:36, realizadas:30, email:"", tel:"", plan:"12 Clases",
    pagos:{Enero:500000,Febrero:650000,Marzo:650000,Abril:650000},
    asistencia:[{f:"07/04",m:"P"},{f:"09/04",m:"P"},{f:"14/04",m:"P"},{f:"16/04",m:"P"},{f:"28/04",m:"P"},{f:"30/04",m:"I"}] },
  { id:17, pin:"1717", nombre:"Martin Cueto",    iniciales:"MC", estado:"OK",      abonadas:21, realizadas:17, email:"", tel:"", plan:"8 Clases",
    pagos:{Enero:380000,Febrero:650000,Marzo:650000},
    asistencia:[] },
  { id:18, pin:"1818", nombre:"Guada Rolon",     iniciales:"GR", estado:"OK",      abonadas:19, realizadas:15, email:"", tel:"", plan:"8 Clases",
    pagos:{Enero:380000,Febrero:380000,Marzo:380000,Abril:380000},
    asistencia:[{f:"30/04",m:"P"}] },
  { id:27, pin:"2727", nombre:"Franco Verano",   iniciales:"FV", estado:"OK",      abonadas:30, realizadas:24, email:"", tel:"", plan:"12 Clases",
    pagos:{Enero:650000,Febrero:650000,Marzo:650000,Abril:650000},
    asistencia:[{f:"16/04",m:"P"},{f:"24/04",m:"P"},{f:"30/04",m:"P"}] },
  { id:30, pin:"3030", nombre:"Arturo Grau",     iniciales:"AG", estado:"OK",      abonadas:51, realizadas:44, email:"", tel:"", plan:"12 Clases",
    pagos:{Enero:950000,Febrero:950000,Marzo:950000,Abril:950000},
    asistencia:[{f:"07/04",m:"P"},{f:"09/04",m:"P"},{f:"14/04",m:"I"},{f:"16/04",m:"P"},{f:"24/04",m:"P"},{f:"28/04",m:"I"},{f:"30/04",m:"X"}] },
  { id:45, pin:"4545", nombre:"Mauro Coche",     iniciales:"MC", estado:"OK",      abonadas:40, realizadas:37, email:"", tel:"", plan:"8 Clases",
    pagos:{Enero:650000,Febrero:650000,Marzo:650000,Abril:650000},
    asistencia:[{f:"07/04",m:"P"},{f:"09/04",m:"P"},{f:"14/04",m:"P"},{f:"16/04",m:"P"},{f:"24/04",m:"P"},{f:"28/04",m:"P"},{f:"30/04",m:"P"}] },
  { id:47, pin:"4747", nombre:"Marcos Ibañez",   iniciales:"MI", estado:"OK",      abonadas:14, realizadas:13, email:"", tel:"", plan:"8 Clases",
    pagos:{Marzo:650000,Abril:650000},
    asistencia:[{f:"14/04",m:"P"},{f:"28/04",m:"P"}] },
  { id:52, pin:"5252", nombre:"Yanina",          iniciales:"YA", estado:"OK",      abonadas:13, realizadas:10, email:"", tel:"", plan:"8 Clases",
    pagos:{Marzo:650000,Abril:650000},
    asistencia:[] },
];
...
function AdminAlumnos({students}){
  ...
  const filtered=useMemo(()=>students.filter(s=>{
    return s.nombre.toLowerCase().includes(search.toLowerCase()) && (filter==="TODOS"||s.estado===filter);
  ...
  return (
    <div style={{padding:28}}>
      ...
      <div style={{display:"flex",gap:10,marginBottom:18,flexWrap:"wrap"}}>
        <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="🔍 Buscar alumno..." style={{flex:"1 1 180px",padding:"9px 14px",background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:8,color:B.text,fontSize:13,outline:"none"}}/>
        {["TODOS","OK","VENCIDO"].map(f=>(
          <button key={f} onClick={()=>setFilter(f)} style={{padding:"8px 14px",borderRadius:8,border:`1px solid ${filter===f?B.gold:B.border}`,background:filter===f?B.goldBg:B.bgCard,color:filter===f?B.gold:B.textSub,cursor:"pointer",fontSize:12,fontWeight:filter===f?600:400}}>{f}</button>
        ))}
      </div>
    ...
    <div style={{padding:28}}>
      ...
      <div style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:12,padding:"14px 18px",marginBottom:16}}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          {["P","I","X","R"].map(k=>{const s=AT[k];return<button key={k} onClick={()=>markAll(k)} style={{padding:"7px 16px",borderRadius:8,border:`1px solid ${s.border}`,background:s.bg,color:s.text,fontSize:13,fontWeight:700,cursor:"pointer"}}>{k} — {s.label}</button>;})}
        </div>
      </div>
      ...
      <div style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:12,overflow:"auto"}}>
        <table style={{width:"100%",borderCollapse:"collapse"}}>
          <thead><tr style={{borderBottom:`1px solid ${B.border}`}}>
            ...
            {labels.map(l=><th key={l} style={{padding:"11px 14px",textAlign:"right",fontSize:11,color:B.textSub,fontWeight:600,textTransform:"uppercase"}}>{l}</th>)}
...
function StudentMode({student,onLogout}){
  ...
  // Cambio de PIN local (sin API por ahora)
  const handleCambiarPIN = () => {
    if(pinViejo!==student.pin){ setMensajePIN("PIN actual incorrecto."); return; }
    if(pinNuevo.length!==4||!/^\d{4}$/.test(pinNuevo)){ setMensajePIN("El nuevo PIN debe tener 4 dígitos."); return; }
    setMensajePIN("✅ PIN actualizado. Cerrá sesión y volvé a entrar.");
    // TODO: llamar apiCambiarPIN(student.nombre, pinViejo, pinNuevo) cuando tengas API
  };
      ...
      <div style={{maxWidth:520,margin:"0 auto",padding:"24px 20px"}}>
        ...
        {tab==="cuenta"&&(
          <div>
            ...
            {/* Cambio de PIN */}
            <button onClick={()=>{setCambiandoPIN(!cambiandoPIN);setMensajePIN("");}} style={{width:"100%",padding:"12px",background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:10,color:B.text,fontSize:13,cursor:"pointer",marginBottom:cambiandoPIN?0:0}}>
              🔐 {cambiandoPIN?"Cancelar":"Cambiar mi PIN"}
            </button>
            {cambiandoPIN&&(
              <div style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:12,padding:16,marginTop:10,display:"flex",flexDirection:"column",gap:10}}>
                <input type="password" placeholder="PIN actual" value={pinViejo} onChange={e=>setPinViejo(e.target.value)} maxLength={4} style={{padding:"10px 12px",background:B.bg,border:`1px solid ${B.border}`,borderRadius:8,color:B.text,fontSize:14,outline:"none"}}/>
                <input type="password" placeholder="Nuevo PIN (4 dígitos)" value={pinNuevo} onChange={e=>setPinNuevo(e.target.value)} maxLength={4} style={{padding:"10px 12px",background:B.bg,border:`1px solid ${B.border}`,borderRadius:8,color:B.text,fontSize:14,outline:"none"}}/>
                <button onClick={handleCambiarPIN} style={{padding:"10px",background:B.gold,color:B.bgDark,border:"none",borderRadius:8,fontWeight:700,cursor:"pointer",fontSize:14}}>Guardar nuevo PIN</button>
                {mensajePIN&&<div style={{fontSize:12,color:B.gold,textAlign:"center"}}>{mensajePIN}</div>}
              </div>
            )}
            {(student.email||student.tel)&&(
              <div style={{background:B.bgCard,border:`1px solid ${B.border}`,borderRadius:12,padding:"14px 16px",marginTop:12}}>
        ...
        {/* ASISTENCIA — usa a.m consistentemente */}
        {tab==="asistencia"&&(
          <div>
        ...
        {/* PAGOS — usa student.pagos consistentemente */}
        {tab==="pagos"&&(
          <div>
